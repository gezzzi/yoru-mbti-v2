...
import { personalityTypes, getCategoryColor, getCategoryName } from '@/data/en/personalityTypes';
...
// Image or emoji display component
...
export default function EnPersonalityTypesPage() {
    ...
    return (
      <ScrollAnimation key={type.code} animation="fadeInUp" delay={delay}>
        ...
        <div className="text-center mb-6 relative z-20">
          <div className={`w-full max-w-[24rem] h-[24rem] mx-auto mb-4 rounded-2xl overflow-hidden ${scheme.imageBg} flex items-center justify-center`}>
          ...
          <ScrollAnimation animation="fadeIn" duration={800}>
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 pt-24 select-none">
                <NeonText text="Types" specialCharIndex={0} className="flex justify-center gap-1" />
              </h1>
            </div>
          </ScrollAnimation>
        ...
        <ScrollAnimation animation="fadeInUp" delay={1000}>
          <div className="text-center mt-20 bg-white/10 backdrop-blur-sm rounded-3xl p-12 shadow-xl border border-white/20">
            ...
            <p className="text-xl text-[#e0e7ff]/80 mb-8 max-w-2xl mx-auto">
              Take the personality test and discover your true personality type.
            </p>
            <Link
              href="/en/test"
